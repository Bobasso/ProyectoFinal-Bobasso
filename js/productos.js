            ...
            data.forEach((element, index) => {
                ...
                div.innerHTML = `
                    ...
                    <div class="card-container">
                        ...
                        <button class="ver-mas" value="${element.id}">Ver más</button>
                    </div>
                `;
                gridContainer.appendChild(div);
            });

            // Después de agregar los productos, ahora seleccionamos los botones
            const idProducto = document.querySelectorAll(".ver-mas");
            idProducto.forEach((element, i) => {
                element.addEventListener('click', () => {
                    // Si no está logueado, no podrá ver los productos
                        ...
                        div.innerHTML = `
                            <div class="product-container">
                                <div class="product-image">
                                    <img src="${selectedProduct.src}" alt="Producto">
                                </div>
                                <div class="product-details">
                                    <h1>${selectedProduct.nombre}</h1>
                                    <p>Precio: U$D${selectedProduct.precio}</p>
                                    <p>Talle</p>
